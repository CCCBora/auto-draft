...
# paper_info - a dictionary containing
#   1. title (user input)
#   2. references (generated by Latent Semantic Indexing (LSI) or Latent Dirichlet Allocation (LDA)) (a dictionary; {"paper_id": "paper summary"})
#   3. figures (generated; ask GPT) (a dictionary; {"figure_path": "a very general description of figures"})
#   4. tables (generated; ask GPT) (a latex file; input it somewhere)
#   (the following shares the same prompts)
#   5. introduction (generated by AI)
#   6. related works (generated by AI)
#   7. contributions (generated by AI)
#   8. backgrounds (generated by AI)
#   9. methodology (generated by AI)
#   10. experiments and results (generated by AI)
#   11. conclusion (generated by AI)
...
def generate_experiments_prompts(paper_info):
    prompts = f"I am writing a machine learning paper with the title {paper_info['title']}\n" \
              ...
              r"Response in a dictionary format like {method_name_1: 2, method_name_2: 5, ...}. And use abbreviation to make their names have 5 characters or less."
    return prompts
